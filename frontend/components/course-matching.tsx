...
return (
  <div className="space-y-8">
    <div className="flex items-center justify-between border-b border-border pb-4">
      ...
      <Button variant="outline" size="sm" onClick={onReset} className="gap-2 bg-transparent cursor-pointer">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-5 justify-end"> 
          ...
          <h1 className="text-5xl font-semibold text-foreground">
            {totalCredits} / {transferData.total_credits}
          </h1>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 w-full">
          {transferData.courses.map((course, index) => (
            ...
            >
              <div className="flex gap-5 border-black justify-between w-full items-center">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Transfer courses without articulation agreements or may satisfy some elective requirement
          </p>
        </div>
